    ...
    <div class="col-12">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                ...
                <button @click="switchKop" class="btn btn-primary shadow-sm"><i class="fas fa-fw fa-exchange-alt"></i> Tukar Kop</button>
                <input type="file" id="file_upload" accept=".html" style="display: none;">
            </div>