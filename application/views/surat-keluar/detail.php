    ...
    <div class="row my-4">
        ...
        <div class="col">
            ...
            <div class="form-group">
                ...
                <?php else : ?>
                    <a href="<?= base_url('export/download/') . $surat['file']; ?>" class="form-control border-left-primary"><?= $surat['file']; ?></a>
                <?php endif; ?>
            </div>
            <a href="<?= base_url('surat-keluar/ubah/') . $surat['id']; ?>" class="float-right btn btn-primary">Ubah</a>
